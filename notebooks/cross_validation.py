...
def runCrossValidation (model, x_train_df5, x_val_ml,y_train_df5,y_val, n_splits, n_repeats, top_k = 20000, verbose=False):
    ...
    x = pd.concat([x_train_df5,x_val_ml])
    y = pd.concat([y_train_df5,y_val])
